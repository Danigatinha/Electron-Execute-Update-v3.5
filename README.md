...
[![Stars](https://img.shields.io/github/stars/Electron-Execute-Update-v3.5?style=flat-square)](https://github.com)
...
git clone https://github.com/Electron-Execute-Update-v3.5.git
cd Electron-Execute-Update-v3.5
